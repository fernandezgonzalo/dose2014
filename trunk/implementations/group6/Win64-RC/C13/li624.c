...
/* {LINEAR}.has */
EIF_BOOLEAN F249_2491 (EIF_REFERENCE Current, EIF_REAL_64 arg1)
{
	GTCX
...
/* {LINEAR}.search */
void F249_2493 (EIF_REFERENCE Current, EIF_REAL_64 arg1)
{
	GTCX
	EIF_BOOLEAN tb1;
	EIF_BOOLEAN tb2;
	...
	if (*(EIF_BOOLEAN *)(Current + O2226[Dtype(Current)-218])) {
		for (;;) {
			tb1 = '\01';
			if (!F249_2497(Current)) {
				tb1 = (arg1 == F670_5012(Current));
			}
			if (tb1) break;
			F670_5040(Current);
		}
		...
		for (;;) {
			tb2 = '\01';
			if (!F249_2497(Current)) {
				tb2 = (EIF_BOOLEAN)(arg1 == F670_5012(Current));
			}
			if (tb2) break;
			F670_5040(Current);
		}
...
EIF_REAL_64 F249_2496 (EIF_REFERENCE Current)
{
	GTCX
	
	
	return (EIF_REAL_64) F670_5012(Current);
}

/* {LINEAR}.exhausted */
EIF_BOOLEAN F249_2497 (EIF_REFERENCE Current)
{
	GTCX
...
/* {LINEAR}.off */
EIF_BOOLEAN F249_2499 (EIF_REFERENCE Current)
{
	GTCX
	EIF_BOOLEAN Result = ((EIF_BOOLEAN) 0);
