...
void F684_5174 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	...
	*(EIF_NATURAL_16 *)(Current+ _I16OFF_0_0_2_) = (EIF_NATURAL_16) loc1;
	...
	loc3 += tu8_1;
	loc3 = eif_bit_shift_left(loc3,((EIF_INTEGER_32) 8L));
	tu1_1 = F610_4819(RTCV(arg1), ((EIF_INTEGER_32) 13L));
	tu8_1 = (EIF_NATURAL_64) tu1_1;
	loc3 += tu8_1;
	loc3 = eif_bit_shift_left(loc3,((EIF_INTEGER_32) 8L));
	tu1_1 = F610_4819(RTCV(arg1), ((EIF_INTEGER_32) 14L));
	tu8_1 = (EIF_NATURAL_64) tu1_1;
	loc3 += tu8_1;
	loc3 = eif_bit_shift_left(loc3,((EIF_INTEGER_32) 8L));
	tu1_1 = F610_4819(RTCV(arg1), ((EIF_INTEGER_32) 15L));
	tu8_1 = (EIF_NATURAL_64) tu1_1;
	loc3 += tu8_1;
	loc3 = eif_bit_shift_left(loc3,((EIF_INTEGER_32) 8L));
	tu1_1 = F610_4819(RTCV(arg1), ((EIF_INTEGER_32) 16L));
	tu8_1 = (EIF_NATURAL_64) tu1_1;
	loc3 += tu8_1;
...
/* {UUID}.hash_code */
EIF_INTEGER_32 F684_5180 (EIF_REFERENCE Current)
{
	GTCX
	EIF_NATURAL_64 tu8_1;
...
/* {UUID}.is_less */
EIF_BOOLEAN F684_5183 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	EIF_NATURAL_64 tu8_1;
...
/* {UUID}.out */
EIF_REFERENCE F684_5185 (EIF_REFERENCE Current)
{
	GTCX
	...
	F737_5723(RTCV(tr1), ((EIF_INTEGER_32) 37L));
	...
	*(EIF_NATURAL_64 *)tr1 = tu8_1;
	...
	tr1 = F841_7011(RTCV(tr1));
	tr1 = F741_5984(RTCV(tr1), ((EIF_INTEGER_32) 5L), ((EIF_INTEGER_32) 16L));
	F741_5937(RTCV(Result), tr1);
	RTLE;
	return Result;
}
