...
void F551_4583 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
...
EIF_POINTER F551_4584 (EIF_REFERENCE Current)
{
	GTCX
	...
	Result = *(EIF_POINTER *)(eif_optimize_return = 1, (FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE, EIF_INTEGER_32)) R3942[Dtype(tr1)-578])(RTCV(tr1), *(EIF_INTEGER_32 *)(Current+ _LNGOFF_1_1_0_1_)));
	RTLE;
	return Result;
}

/* {INDEXABLE_ITERATION_CURSOR}.new_cursor */
EIF_REFERENCE F551_4590 (EIF_REFERENCE Current)
{
	GTCX
...
EIF_BOOLEAN F551_4596 (EIF_REFERENCE Current)
{
	GTCX
	EIF_REFERENCE tr1 = NULL;
	EIF_BOOLEAN tb1;
	...
	RTGC;
	Result = '\01';
	if (!(EIF_BOOLEAN) !F551_4598(Current)) {
		tr1 = *(EIF_REFERENCE *)(Current);
...
EIF_BOOLEAN F551_4598 (EIF_REFERENCE Current)
{
	GTCX
	EIF_REFERENCE loc1 = (EIF_REFERENCE) 0;
	EIF_REFERENCE tr1 = NULL;
...
void F551_4603 (EIF_REFERENCE Current)
{
	GTCX
	EIF_REFERENCE loc1 = (EIF_REFERENCE) 0;
...
void F551_4604 (EIF_REFERENCE Current)
{
	GTCX
	RTLD;
...
EIF_REFERENCE F551_4605 (EIF_REFERENCE Current)
{
...
EIF_REFERENCE F551_4606 (EIF_REFERENCE Current)
{
	GTCX
	EIF_REFERENCE tr1 = NULL;
	EIF_REFERENCE Result = ((EIF_REFERENCE) 0);
