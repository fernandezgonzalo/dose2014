...
/* {LIST}.is_equal */
EIF_BOOLEAN F646_4918 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	...
	if ((EIF_BOOLEAN)(Current == arg1)) {
		...
		Result = '\0';
		tb1 = '\0';
		tb2 = F290_2518(RTCV(arg1));
		if ((EIF_BOOLEAN)(F290_2518(Current) == tb2)) {
		...
		if (tb1) {
			...
			Result = (EIF_BOOLEAN)(F675_5029(Current) == ti4_1);
		}
		tb1 = '\0';
		if (Result) {
		...
		if (tb1) {
			tb1 = '\0';
			tr1 = F675_5018(Current);
			loc1 = tr1;
			if (EIF_TEST(loc1)) {
				tr1 = F675_5018(RTCV(arg1));
				loc2 = tr1;
				tb1 = EIF_TEST(loc2);
			}
			if (tb1) {
				...
				for (;;) {
					tb1 = '\01';
					if (!F646_4919(Current)) {
						tb1 = (EIF_BOOLEAN) !Result;
					}
					if (tb1) break;
					if (*(EIF_BOOLEAN *)(Current + O2226[dtype-218])) {
						tu1_1 = F675_5012(Current);
						tu1_2 = F675_5012(RTCV(arg1));
...
/* {LIST}.after */
EIF_BOOLEAN F646_4919 (EIF_REFERENCE Current)
{
	GTCX
	EIF_INTEGER_32 ti4_1;
...
/* {LIST}.before */
EIF_BOOLEAN F646_4920 (EIF_REFERENCE Current)
{
	GTCX
	EIF_INTEGER_32 ti4_1;
	EIF_BOOLEAN Result = ((EIF_BOOLEAN) 0);
