...
EIF_REFERENCE F930_8029 (EIF_REFERENCE Current)
{
	GTCX
	RTOSC (8029,RTMS_EX_H(":/-, .",6,872260142));
}

/* {FIND_SEPARATOR_FACILITY}.find_separator */
EIF_INTEGER_32 F930_8030 (EIF_REFERENCE Current, EIF_REFERENCE arg1, EIF_INTEGER_32 arg2)
{
	GTCX
	...
	for (;;) {
		ti4_1 = *(EIF_INTEGER_32 *)(RTCV(RTOSCF(8029,F930_8029,(Current)))+ _LNGOFF_1_1_0_2_);
		if ((EIF_BOOLEAN) (loc1 > ti4_1)) break;
		tr1 = RTOSCF(8029,F930_8029,(Current));
		tc1 = F741_5904(RTCV(tr1), loc1);
		loc2 = F737_5734(RTCV(arg1), tc1, ((EIF_INTEGER_32) 1L));
		if ((EIF_BOOLEAN)(loc2 != ((EIF_INTEGER_32) 0L))) {
			loc5 = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
			tr1 = RTOSCF(8029,F930_8029,(Current));
			tc1 = F741_5904(RTCV(tr1), loc1);
			loc2 = F737_5734(RTCV(arg1), tc1, arg2);
	...
	if ((EIF_BOOLEAN) !loc5) {
		...
		loc4 = F741_5984(RTCV(arg1), loc1, (EIF_INTEGER_32) (loc1 + ((EIF_INTEGER_32) 2L)));
		tr1 = RTMS_EX_H("[0]",3,5976157);
		if (F1_10(Current, loc4, tr1)) {
			loc1 += ((EIF_INTEGER_32) 3L);
		}
		loc3 = F741_5904(RTCV(arg1), loc1);
		for (;;) {
			tb1 = '\01';
			ti4_2 = *(EIF_INTEGER_32 *)(RTCV(arg1)+ _LNGOFF_1_1_0_2_);
			if (!(EIF_BOOLEAN) (loc1 > ti4_2)) {
				tc1 = F741_5904(RTCV(arg1), loc1);
			...
			if ((EIF_BOOLEAN) (loc1 <= ti4_2)) {
				...
				if (tb2) {
					...
					if (tb3) {
						tb3 = '\0';
						tb4 = F733_5566(RTCV(arg1), (EIF_INTEGER_32) (loc1 + ((EIF_INTEGER_32) 1L)));
						if (tb4) {
							tc1 = F741_5903(RTCV(arg1), (EIF_INTEGER_32) (loc1 + ((EIF_INTEGER_32) 1L)));
...
EIF_REFERENCE F930_8031 (EIF_REFERENCE Current, EIF_REFERENCE arg1, EIF_INTEGER_32 arg2, EIF_INTEGER_32 arg3)
{
	GTCX
	EIF_INTEGER_32 loc1 = (EIF_INTEGER_32) 0;
	...
	if ((EIF_BOOLEAN) (arg3 > ((EIF_INTEGER_32) 0L))) {
		loc2 = F741_5984(RTCV(arg1), arg2, (EIF_INTEGER_32) (arg3 - ((EIF_INTEGER_32) 1L)));
		loc3 = F741_5984(RTCV(arg1), arg3, arg3);
	} else {
		loc1 = F60_868(Current, arg3);
		loc2 = F741_5984(RTCV(arg1), arg2, loc1);
