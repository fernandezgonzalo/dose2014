note
	description : "The main class of the wbpms. Sets up the router and instanciates the controllers and database."
	author		: "hce"
...
feature {NONE} -- Initialization
	...
	path_to_db_file: STRING
		...
		once
			Result := ".." + Operating_environment.directory_separator.out + "wbpms.db"
		end
