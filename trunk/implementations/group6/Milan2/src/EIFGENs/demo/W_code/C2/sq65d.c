...
static EIF_TYPE_INDEX gen_type0_65 [] = {414,64,0xFFFF};
...
static struct desc_info desc_65[] = {
	{(BODY_INDEX) 1071, (BODY_INDEX) -1, INVALID_DTYPE, NULL},
	{0, (BODY_INDEX)-1, 310, NULL},
	{1, (BODY_INDEX)-1, 414, gen_type0_65},
	...
	{1074, 0, 317, NULL},
	{1070, (BODY_INDEX)-1, 297, NULL},
	{1067, (BODY_INDEX)-1, 307, NULL},
	{1068, (BODY_INDEX)-1, 297, NULL},
	{1069, (BODY_INDEX)-1, 297, NULL},
};
...
void Init65(void)
{
	IDSC(desc_65, 0, 64);
	IDSC(desc_65 + 1, 2, 64);
	IDSC(desc_65 + 32, 261, 64);
	IDSC(desc_65 + 36, 259, 64);
}
