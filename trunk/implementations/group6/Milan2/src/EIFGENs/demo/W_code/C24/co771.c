...
extern EIF_TYPED_VALUE F771_2416(EIF_REFERENCE);
extern EIF_TYPED_VALUE F771_2417(EIF_REFERENCE);
extern EIF_TYPED_VALUE F771_2418(EIF_REFERENCE);
extern void F771_2419(EIF_REFERENCE);
extern void F771_2420(EIF_REFERENCE);
...
/* {CONTAINER}.empty */
EIF_TYPED_VALUE F771_2416 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 770, Current, 0, 0, 2404);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(770, Current, 2404);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F771_2417 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F771_2418 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 770, Current, 0, 0, 2401);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(770, Current, 2401);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
void F771_2419 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 770, Current, 0, 0, 2402);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(770, Current, 2402);
	RTIV(Current, RTAL);
...
void F771_2420 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 770, Current, 0, 0, 2403);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(770, Current, 2403);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("changeable_comparison_criterion", EX_PRE);
