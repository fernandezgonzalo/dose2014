...
extern EIF_TYPED_VALUE F457_1367(EIF_REFERENCE);
extern void F457_1368(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F457_1369(EIF_REFERENCE);
...
/* {LINKABLE}.right */
EIF_TYPED_VALUE F457_1367 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
/* {LINKABLE}.put_right */
void F457_1368 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 456, Current, 0, 1, 1367);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(456, Current, 1367);
	RTCC(arg1, 456, l_feature_name, 1, Dftype(Current));
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 1295, 0xF80001C8, 0); /* right */
...
void F457_1369 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 456, Current, 0, 0, 1368);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(456, Current, 1368);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 1295, 0xF80001C8, 0); /* right */
