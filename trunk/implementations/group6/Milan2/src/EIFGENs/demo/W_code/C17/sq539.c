...
extern void F539_8117(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F539_8118(EIF_REFERENCE);
extern EIF_TYPED_VALUE F539_8119(EIF_REFERENCE);
extern EIF_TYPED_VALUE F539_8120(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F539_8121(EIF_REFERENCE);
extern EIF_TYPED_VALUE F539_8122(EIF_REFERENCE);
extern void F539_8236(EIF_REFERENCE, int);
...
void F539_8117 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 538, Current, 0, 2, 13688);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(538, Current, 13688);
	if (arg1) {
		RTCC(arg1, 538, l_feature_name, 1, 306);
	}
	RTCC(arg2, 538, l_feature_name, 2, RTWCT(6383, dtype, Dftype(Current)));
	RTIV(Current, RTAL);
...
body:;
	...
	*(EIF_REFERENCE *)(Current + RTWA(6382, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(6);
	RTDBGAA(Current, dtype, 6383, 0xF8000000, 0); /* value */
...
EIF_TYPED_VALUE F539_8118 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F539_8119 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F539_8120 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 538, Current, 0, 1, 13691);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(538, Current, 13691);
	RTCC(arg1, 538, l_feature_name, 1, RTWCT(6383, Dtype(Current), Dftype(Current)));
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F539_8121 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_UINT8;
...
EIF_TYPED_VALUE F539_8122 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 538, Current, 0, 0, 13686);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(538, Current, 13686);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F539_8236 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 538, Current, 0, 8235);
	RTSA(dtype);
	RTME(dtype, 0);
