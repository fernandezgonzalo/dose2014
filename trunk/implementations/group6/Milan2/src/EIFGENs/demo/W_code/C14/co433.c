...
extern EIF_TYPED_VALUE F433_2469(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F433_2472(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F433_2469 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 432, Current, 0, 1, 2791);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(432, Current, 2791);
	RTCC(arg1, 432, l_feature_name, 1, RTWCT(2169, Dtype(Current), Dftype(Current)));
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
	
	ur1 = RTCCL(arg1);
	Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(2161, Dtype(Current)))(Current, ur1x)).it_b);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
...
/* {COLLECTION}.fill */
void F433_2472 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 432, Current, 1, 1, 2792);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(432, Current, 2792);
	if (arg1) {
		{
			...
			RTCC(arg1, 432, l_feature_name, 1, typres0);
		}
	}
	RTIV(Current, RTAL);
