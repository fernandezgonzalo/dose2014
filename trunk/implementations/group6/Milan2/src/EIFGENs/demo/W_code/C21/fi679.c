...
extern EIF_TYPED_VALUE F679_2456(EIF_REFERENCE);
extern void F679_8160(EIF_REFERENCE, int);
...
/* {FINITE}.is_empty */
EIF_TYPED_VALUE F679_2456 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 678, Current, 0, 0, 2683);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(678, Current, 2683);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {FINITE}._invariant */
void F679_8160 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 678, Current, 0, 8159);
	RTSA(dtype);
	RTME(dtype, 0);
