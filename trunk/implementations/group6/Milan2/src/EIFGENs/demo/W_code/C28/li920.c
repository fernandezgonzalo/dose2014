...
extern EIF_TYPED_VALUE F920_1367(EIF_REFERENCE);
extern void F920_1368(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F920_1369(EIF_REFERENCE);
...
/* {LINKABLE}.right */
EIF_TYPED_VALUE F920_1367 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
/* {LINKABLE}.put_right */
void F920_1368 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 919, Current, 0, 1, 1373);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(919, Current, 1373);
	RTCC(arg1, 919, l_feature_name, 1, Dftype(Current));
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 1295, 0xF8000397, 0); /* right */
...
void F920_1369 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 919, Current, 0, 0, 1374);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(919, Current, 1374);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 1295, 0xF8000397, 0); /* right */
