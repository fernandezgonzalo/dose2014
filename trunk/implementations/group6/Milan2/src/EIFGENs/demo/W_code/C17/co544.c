...
extern EIF_TYPED_VALUE F544_2416(EIF_REFERENCE);
extern EIF_TYPED_VALUE F544_2417(EIF_REFERENCE);
extern EIF_TYPED_VALUE F544_2418(EIF_REFERENCE);
extern void F544_2419(EIF_REFERENCE);
extern void F544_2420(EIF_REFERENCE);
...
/* {CONTAINER}.empty */
EIF_TYPED_VALUE F544_2416 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 543, Current, 0, 0, 2374);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(543, Current, 2374);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F544_2417 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F544_2418 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 543, Current, 0, 0, 2371);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(543, Current, 2371);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
void F544_2419 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 543, Current, 0, 0, 2372);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(543, Current, 2372);
	RTIV(Current, RTAL);
...
void F544_2420 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 543, Current, 0, 0, 2373);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(543, Current, 2373);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("changeable_comparison_criterion", EX_PRE);
