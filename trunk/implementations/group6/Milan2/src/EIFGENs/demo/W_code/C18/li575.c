...
extern EIF_TYPED_VALUE F575_4505(EIF_REFERENCE);
extern EIF_TYPED_VALUE F575_4506(EIF_REFERENCE);
extern void F575_4507(EIF_REFERENCE);
extern void F575_4508(EIF_REFERENCE);
extern EIF_TYPED_VALUE F575_4509(EIF_REFERENCE);
extern EIF_TYPED_VALUE F575_4510(EIF_REFERENCE);
...
EIF_TYPED_VALUE F575_4505 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 574, Current, 1, 0, 5223);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(574, Current, 5223);
	RTIV(Current, RTAL);
...
body:;
	...
	if (tb1) {
		...
		Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(2574, 556))(Current)).it_b);
	} else {
		RTHOOK(4);
...
EIF_TYPED_VALUE F575_4506 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 574, Current, 0, 0, 5224);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(574, Current, 5224);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tb1 = *(EIF_BOOLEAN *)(Current + RTWA(3820, dtype));
	if (tb1) {
		...
		Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(2575, 556))(Current)).it_b);
	} else {
		RTHOOK(3);
		RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
void F575_4507 (EIF_REFERENCE Current)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 574, Current, 0, 0, 5225);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(574, Current, 5225);
	RTIV(Current, RTAL);
	RTHOOK(1);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(3826, 556))(Current);
	RTHOOK(2);
	tb1 = *(EIF_BOOLEAN *)(Current + RTWA(3820, dtype));
	if ((EIF_BOOLEAN) !tb1) {
		RTHOOK(3);
		RTDBGAA(Current, dtype, 3829, 0xF800023F, 0); /* active */
...
void F575_4508 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 574, Current, 2, 0, 5226);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(574, Current, 5226);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("valid_position", EX_PRE);
...
body:;
	...
	RTHOOK(2);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(2576, 556))(Current);
	RTHOOK(3);
	tb1 = *(EIF_BOOLEAN *)(Current + RTWA(3820, dtype));
	if ((EIF_BOOLEAN) !tb1) {
		RTHOOK(4);
...
EIF_TYPED_VALUE F575_4509 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F575_4510 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
