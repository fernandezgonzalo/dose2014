...
extern void F578_2611(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F578_2612(EIF_REFERENCE);
extern EIF_TYPED_VALUE F578_2613(EIF_REFERENCE);
extern EIF_TYPED_VALUE F578_2614(EIF_REFERENCE);
extern void F578_8166(EIF_REFERENCE, int);
...
void F578_2611 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define arg3 arg3x.it_b
	...
	RTEAA(l_feature_name, 577, Current, 0, 3, 3058);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(577, Current, 3058);
	RTCC(arg1, 577, l_feature_name, 1, RTWCT(2301, dtype, Dftype(Current)));
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 2301, 0xF800023F, 0); /* active */
...
EIF_TYPED_VALUE F578_2612 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F578_2613 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F578_2614 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
void F578_8166 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 577, Current, 0, 8165);
	RTSA(dtype);
	RTME(dtype, 0);
