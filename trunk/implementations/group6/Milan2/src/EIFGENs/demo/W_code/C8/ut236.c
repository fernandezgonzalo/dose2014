...
extern EIF_TYPED_VALUE F236_3016(EIF_REFERENCE);
...
EIF_TYPED_VALUE F236_3016 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 235, Current, 0, 0, 3452);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(235, Current, 3452);
	RTIV(Current, RTAL);
	RTHOOK(1);
