...
extern EIF_TYPED_VALUE F137_1959(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F137_1960(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F137_1959 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_i4
	...
	RTEAA(l_feature_name, 136, Current, 0, 1, 1899);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(136, Current, 1899);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F137_1960 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_i4
	...
	RTEAA(l_feature_name, 136, Current, 0, 1, 1900);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(136, Current, 1900);
	RTIV(Current, RTAL);
	RTHOOK(1);
	switch (arg1) {
		case 100L:
