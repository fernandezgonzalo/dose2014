...
extern EIF_TYPED_VALUE F141_2029(EIF_REFERENCE);
...
RTOID (F141_2029)
EIF_TYPED_VALUE F141_2029 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 140, Current, 0, 0, 1969);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(140, Current, 1969);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
