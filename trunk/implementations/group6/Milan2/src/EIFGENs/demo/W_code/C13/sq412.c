...
extern void F412_8193(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F412_8194(EIF_REFERENCE);
...
void F412_8193 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 411, Current, 1, 2, 13783);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(411, Current, 13783);
	if (arg1) {
...
body:;
	RTHOOK(6);
	tb1 = *(EIF_BOOLEAN *)(Current + RTWA(6449, dtype));
	if (tb1) {
		RTHOOK(7);
...
EIF_TYPED_VALUE F412_8194 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
