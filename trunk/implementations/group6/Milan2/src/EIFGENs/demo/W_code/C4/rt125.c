...
extern void F125_1766(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F125_1767(EIF_REFERENCE, EIF_TYPED_VALUE);
...
void F125_1766 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 124, Current, 0, 1, 1716);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(124, Current, 1716);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWC(4742, Dtype(tr1)))(tr1, uc1x, ui4_1x);
	RTNHOOK(1,3);
	ur1 = RTCCL(tr1);
...
void F125_1767 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 124, Current, 0, 1, 1715);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(124, Current, 1715);
	if (arg1) {
		RTCC(arg1, 124, l_feature_name, 1, 314);
	}
	RTIV(Current, RTAL);
