...
extern void F90_1432(EIF_REFERENCE, EIF_TYPED_VALUE);extern void en_local_host_name(EIF_POINTER);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 89, Current, 1, 0, 1431);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(89, Current, 1431);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	RTHOOK(2);
	tp1 = *(EIF_POINTER *)(loc1 + RTVA(3101, "item", loc1));
	up1 = tp1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(1354, Dtype(Current)))(Current, up1x);
	RTHOOK(3);
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 89, Current, 0, 0, 1432);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(89, Current, 1432);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	...
	*((EIF_NATURAL_8 *)tr4+15) = (EIF_NATURAL_8) tu1_1;
	...
	ur2 = RTCCL(tr3);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWC(1395, Dtype(tr1)))(tr1, ur1x, ur2x);
	RTNHOOK(1,1);
	Result = (EIF_REFERENCE) RTCCL(tr1);
	RTVI(Current, RTAL);
	RTRS;
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 89, Current, 0, 0, 1433);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(89, Current, 1433);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF800005B, 0,0); /* Result */
...
void F90_1432 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_p
	...
	RTEAA(l_feature_name, 89, Current, 0, 1, 1434);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 1);
	RTDBGEAA(89, Current, 1434);
