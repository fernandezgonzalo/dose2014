...
static EIF_TYPE_INDEX gen_type0_89 [] = {418,88,0xFFFF};
...
static struct desc_info desc_89[] = {
	...
	{1, (BODY_INDEX)-1, 418, gen_type0_89},
	...
	{1430, (BODY_INDEX)-1, 314, NULL},
	{1427, (BODY_INDEX)-1, 90, NULL},
	{1428, (BODY_INDEX)-1, 90, NULL},
...
void Init89(void)
{
	IDSC(desc_89, 0, 88);
	IDSC(desc_89 + 1, 2, 88);
	IDSC(desc_89 + 32, 453, 88);
	IDSC(desc_89 + 35, 454, 88);
}
