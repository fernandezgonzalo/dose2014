...
extern EIF_TYPED_VALUE F436_4802(EIF_REFERENCE);
extern EIF_TYPED_VALUE F436_4803(EIF_REFERENCE);
extern void F436_4809(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F436_4812(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F436_4813(EIF_REFERENCE);
extern EIF_TYPED_VALUE F436_4814(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F436_4802 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 435, Current, 0, 0, 6811);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(435, Current, 6811);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F436_4803 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 435, Current, 0, 0, 6812);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(435, Current, 6812);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {DYNAMIC_CHAIN}.prune */
void F436_4809 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 435, Current, 0, 1, 6807);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(435, Current, 6807);
	RTCC(arg1, 435, l_feature_name, 1, RTWCT(2217, dtype, Dftype(Current)));
	RTIV(Current, RTAL);
...
void F436_4812 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 435, Current, 0, 1, 6808);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(435, Current, 6808);
	RTCC(arg1, 435, l_feature_name, 1, RTWCT(2217, dtype, Dftype(Current)));
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
void F436_4813 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 435, Current, 0, 0, 6809);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(435, Current, 6809);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
EIF_TYPED_VALUE F436_4814 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 435, Current, 2, 1, 6810);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(435, Current, 6810);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
