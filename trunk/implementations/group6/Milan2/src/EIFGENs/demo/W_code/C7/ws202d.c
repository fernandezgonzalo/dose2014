...
static EIF_TYPE_INDEX gen_type0_202 [] = {414,201,0xFFFF};
...
static struct desc_info desc_202[] = {
	...
	{1, (BODY_INDEX)-1, 414, gen_type0_202},
...
void Init202(void)
{
	...
	IDSC(desc_202 + 32, 280, 201);
	IDSC(desc_202 + 34, 154, 201);
	IDSC(desc_202 + 35, 294, 201);
}
