...
extern EIF_TYPED_VALUE F447_2458(EIF_REFERENCE);
extern void F447_8161(EIF_REFERENCE, int);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F447_2458 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 446, Current, 0, 0, 2696);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(446, Current, 2696);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F447_8161 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 446, Current, 0, 8160);
	RTSA(dtype);
	RTME(dtype, 0);
