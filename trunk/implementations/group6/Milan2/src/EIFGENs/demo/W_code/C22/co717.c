...
extern EIF_TYPED_VALUE F717_2416(EIF_REFERENCE);
extern EIF_TYPED_VALUE F717_2417(EIF_REFERENCE);
extern EIF_TYPED_VALUE F717_2418(EIF_REFERENCE);
extern void F717_2419(EIF_REFERENCE);
extern void F717_2420(EIF_REFERENCE);
...
/* {CONTAINER}.empty */
EIF_TYPED_VALUE F717_2416 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 716, Current, 0, 0, 2399);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(716, Current, 2399);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F717_2417 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F717_2418 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 716, Current, 0, 0, 2396);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(716, Current, 2396);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
void F717_2419 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 716, Current, 0, 0, 2397);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(716, Current, 2397);
	RTIV(Current, RTAL);
...
void F717_2420 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 716, Current, 0, 0, 2398);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(716, Current, 2398);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("changeable_comparison_criterion", EX_PRE);
