...
extern EIF_TYPED_VALUE F598_2456(EIF_REFERENCE);
extern void F598_8160(EIF_REFERENCE, int);
...
/* {FINITE}.is_empty */
EIF_TYPED_VALUE F598_2456 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 597, Current, 0, 0, 2679);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(597, Current, 2679);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {FINITE}._invariant */
void F598_8160 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 597, Current, 0, 8159);
	RTSA(dtype);
	RTME(dtype, 0);
