...
def get_role(session, id_user, id_project):
	uri_get_role = "/api/users/%s/projects/%s/role" % (id_user, id_project)
	headers = {"content-type": "application/json", "accept": "applicacion/json"}
...
def get_devs_from_project(session, id_user, id_project):
	uri_get_devs_from_project = "/api/users/%s/projects/%s/developers" % (id_user, id_project)
	headers = {"content-type": "application/json"}
	return session.get(uri_get_devs_from_project, headers=headers)

def add_dev_from_project(session, id_user, id_project, role):
	uri_add_dev_from_project = "/api/users/%s/projects/%s/developers" % (id_user, id_project)
	payload = {"role": role}
	headers = {"content-type": "application/json"}
...
def delete_dev_from_project(session, id_user, id_project, id_developer):
	uri_delete_dev_from_project = "/api/users/%s/projects/%s/developers/%s" % (id_user, id_project, id_developer)
	headers = {"content-type": "application/json"}
...
def get_ranking(session, id_user, id_project):
	uri_get_ranking = "/api/users/%s/projects/%s/developers/ranking" % (id_user, id_project)
	headers = {"content-type": "application/json"}
...
def add_sprint(session, id_user, id_project, duration):
	uri_add_sprint = "/api/users/%s/projects/%s/sprints" % (id_user, id_project)
...
def get_sprints(session, id_user, id_project):
	uri_get_sprints = "/api/users/%s/projects/%s/sprints" % (id_user, id_project)
	headers = {"content-type": "application/json"}
	return session.get(uri_get_sprints, headers=headers)

def get_sprint(session, id_user, id_project, id_sprint):
	uri_add_sprint = "/api/users/%s/projects/%s/sprints/%s" % (id_user, id_project, id_sprint)
	headers = {"content-type": "application/json"}
	return session.get(uri_get_sprint, headers=headers)

def update_sprint(session, id_user, id_project, duration):
	uri_update_sprint = "/api/users/%s/projects/%s/sprints/%s" % (id_user, id_project, id_sprint)
	payload = {"duration": duration}
	headers = {"content-type": "application/json"}
...
def delete_sprint(session, id_user, id_project, id_sprint):
	uri_delete_sprint = "/api/users/%s/projects/%s/sprints/%s" % (id_user, id_project, id_sprint)
	headers = {"content-type": "application/json"}
...
def add_task(session, id_user, id_project, id_sprint, desc, comment, duration, points, status, id_requirement, id_u):
	uri_add_task = "/api/users/%s/projects/%s/sprints/%s/tasks" % (id_user, id_project)
	payload = {"desc": desc,
				"comment": comment,
				"duration": duration,
				"points": points,
...
def get_task(session, id_user, id_project, id_task):
	uri_get_task = "/api/users/%s/projects/%s/sprints/%s/tasks/%s" % (id_user, id_project, id_task)
	headers = {"content-type": "application/json"}
	return session.get(uri_get_task, headers=headers)

def update_task(session, id_user, id_project, id_sprint, id_task, desc, comment, duration, points, status, id_u):
	uri_add_task = "/api/users/%s/projects/%s/sprints/%s/tasks/%s" % (id_user, id_project, id_task)
	payload = {"desc": desc,
				"comment": comment,
				"duration": duration,
				"points": points,
...
def add_requirement(session, id_user, id_project, estimation, desc):
	uri_add_requirement = "/api/users/%s/projects/%s/requirements" % (id_user, id_project)
...
def get_requirements(session, id_user, id_project):
	uri_get_requirements = "/api/users/%s/projects/%s/requirements" % (id_user, id_project)
	headers = {"content-type": "application/json"}
	return session.get(uri_get_requirements, headers=headers)

def get_requirement(session, id_user, id_project, id_requirement):
	uri_get_requirement = "/api/users/%s/projects/%s/requirements/%s" % (id_user, id_project, id_requirement)
	headers = {"content-type": "application/json"}
...
def update_requirement(session, id_user, id_project, id_requirement, estimation, desc, id_proj):
	uri_update_requirement = "/api/users/%s/projects/%s/requirements/%s" % (id_user, id_project, id_requirement)
...
def delete_requirement(session, id_user, id_project, id_requirement):
	uri_delete_requirement = "/api/users/%s/projects/%s/requirements/%s" % (id_user, id_project, id_requirement)
	headers = {"content-type": "application/json"}
