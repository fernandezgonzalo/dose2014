  ...
  .controller('RequirementCtrl', ['$scope', '$http', '$log',
	function ($scope, $http, $log) {
      ...
      $scope.createSprint = function(name, description, startDate, endDate, projectId) {
		// Creates a new sprint for a project (can be executed only by the project manager and the team leader of the project)
      }
	  
	  $scope.deleteSprint = function(sprintId) {
		// Deletes a sprint (can be executed only by the project manager and the team leader of the project)
      }
	  
	  $scope.editSprint = function(sprintId, name, description, startDate, endDate) {
		// Modifies the name, the description, the start date and the end date of a sprint with certain id(can be executed only by the project manager and the team leader of the project)
      }
