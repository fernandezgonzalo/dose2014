...
static EIF_TYPE_INDEX gen_type0_29 [] = {418,28,0xFFFF};
...
static struct desc_info desc_29[] = {
	{(BODY_INDEX) 506, (BODY_INDEX) -1, INVALID_DTYPE, NULL},
	{0, (BODY_INDEX)-1, 314, NULL},
	{1, (BODY_INDEX)-1, 418, gen_type0_29},
