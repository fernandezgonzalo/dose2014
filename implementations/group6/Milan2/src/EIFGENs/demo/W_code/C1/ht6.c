...
void F6_70 (EIF_REFERENCE Current)
{
	...
	*(EIF_INTEGER_32 *)(Current + RTWA(78, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 5000L);
	RTHOOK(5);
	RTDBGAA(Current, dtype, 73, 0xF8000136, 0); /* document_root */
...
#define arg1 arg1x.it_r
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, Dtype(Current), 74, 0xF8000136, 0); /* http_server_name */
...
#define arg1 arg1x.it_r
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, Dtype(Current), 73, 0xF8000136, 0); /* document_root */
