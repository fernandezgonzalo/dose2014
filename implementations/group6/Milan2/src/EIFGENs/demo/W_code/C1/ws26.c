...
extern EIF_TYPED_VALUE F26_353(EIF_REFERENCE);
extern EIF_TYPED_VALUE F26_354(EIF_REFERENCE);
extern void F26_355(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F26_353 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 25, Current, 0, 0, 361);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(25, Current, 361);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F26_354 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F26_355 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTCC(arg1, 25, l_feature_name, 1, RTWCT(354, dtype, Dftype(Current)));
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 354, 0xF80000C9, 0); /* dispatched_handler */
