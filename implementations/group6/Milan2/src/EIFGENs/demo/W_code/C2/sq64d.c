...
static struct desc_info desc_64[] = {
	{(BODY_INDEX) 1042, (BODY_INDEX) -1, INVALID_DTYPE, NULL},
	...
	{1044, (BODY_INDEX)-1, (EIF_TYPE_INDEX)-1, NULL},
	{1037, 0, 322, NULL},
	{1041, (BODY_INDEX)-1, 301, NULL},
	{1038, (BODY_INDEX)-1, 311, NULL},
	{1039, (BODY_INDEX)-1, 301, NULL},
	{1040, (BODY_INDEX)-1, 301, NULL},
};
...
void Init64(void)
{
	IDSC(desc_64, 0, 63);
	IDSC(desc_64 + 1, 2, 63);
	IDSC(desc_64 + 32, 298, 63);
	IDSC(desc_64 + 36, 297, 63);
}
