...
static EIF_TYPE_INDEX gen_type0_56 [] = {417,55,0xFFFF};
...
static struct desc_info desc_56[] = {
	...
	{1, (BODY_INDEX)-1, 417, gen_type0_56},
	...
	{964, (BODY_INDEX)-1, (EIF_TYPE_INDEX)-1, NULL},
	{965, 0, 110, NULL},
	{966, (BODY_INDEX)-1, (EIF_TYPE_INDEX)-1, NULL},
};
...
void Init56(void)
{
	IDSC(desc_56, 0, 55);
	IDSC(desc_56 + 1, 2, 55);
	IDSC(desc_56 + 32, 390, 55);
	IDSC(desc_56 + 34, 389, 55);
}
