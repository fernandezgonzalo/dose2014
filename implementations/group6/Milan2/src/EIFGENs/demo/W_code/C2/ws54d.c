...
static EIF_TYPE_INDEX gen_type0_54 [] = {414,53,0xFFFF};
...
static struct desc_info desc_54[] = {
	{(BODY_INDEX) 915, (BODY_INDEX) -1, INVALID_DTYPE, NULL},
	{0, (BODY_INDEX)-1, 310, NULL},
	{1, (BODY_INDEX)-1, 414, gen_type0_54},
	...
	{920, (BODY_INDEX)-1, 297, NULL},
	{(BODY_INDEX)-1, (BODY_INDEX)-1, 67, NULL},
	{913, (BODY_INDEX)-1, 306, NULL},
	{(BODY_INDEX)-1, (BODY_INDEX)-1, (EIF_TYPE_INDEX)-1, NULL},
	{914, 8, 280, NULL},
};
...
void Init54(void)
{
	IDSC(desc_54, 0, 53);
	IDSC(desc_54 + 1, 2, 53);
	IDSC(desc_54 + 32, 387, 53);
	IDSC(desc_54 + 33, 386, 53);
	IDSC(desc_54 + 35, 300, 53);
}
