...
static EIF_TYPE_INDEX gen_type0_41 [] = {414,40,0xFFFF};
...
static struct desc_info desc_41[] = {
	...
	{1, (BODY_INDEX)-1, 414, gen_type0_41},
	...
	{842, (BODY_INDEX)-1, (EIF_TYPE_INDEX)-1, NULL},
...
void Init41(void)
{
	IDSC(desc_41, 0, 40);
	IDSC(desc_41 + 1, 2, 40);
	IDSC(desc_41 + 32, 418, 40);
	IDSC(desc_41 + 37, 438, 40);
}
