...
extern EIF_TYPED_VALUE F38_708(EIF_REFERENCE);
extern EIF_TYPED_VALUE F38_709(EIF_REFERENCE);
extern EIF_TYPED_VALUE F38_710(EIF_REFERENCE);
extern EIF_TYPED_VALUE F38_711(EIF_REFERENCE);
extern EIF_TYPED_VALUE F38_712(EIF_REFERENCE);
...
EIF_TYPED_VALUE F38_708 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F38_708,780,RTMS_EX_H("English",7,257590376));
}

/* {DATE_TIME_TOOLS}.days_text */
RTOID (F38_709)
EIF_TYPED_VALUE F38_709 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 37, Current, 0, 0, 780);
	RTSA(Dtype(Current));
	RTSC;
	...
	*((EIF_REFERENCE *)tr2+6) = (EIF_REFERENCE) tr3;
	...
	RTHOOK(2);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(2207, "compare_objects", Result))(Result);
	RTVI(Current, RTAL);
	RTRS;
	RTOTE;
	RTHOOK(3);
...
RTOID (F38_710)
EIF_TYPED_VALUE F38_710 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 37, Current, 0, 0, 781);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
...
RTOID (F38_711)
EIF_TYPED_VALUE F38_711 (EIF_REFERENCE Current)
{
	GTCX
...
RTOID (F38_712)
EIF_TYPED_VALUE F38_712 (EIF_REFERENCE Current)
{
	GTCX
...
{
	GTCX
	RTOTC (F38_713,777,RTMS_EX_H("[0]mm/[0]dd/yyyy",16,1621628025));
}
...
{
	GTCX
	RTOTC (F38_714,778,RTMS_EX_H("hh12:[0]mi:[0]ss.ff3 AM",23,629041741));
}
...
{
	GTCX
	RTOTC (F38_715,779,RTMS_EX_H("[0]mm/[0]dd/yyyy hh12:[0]mi:[0]ss.ff3 AM",40,2104244301));
}
