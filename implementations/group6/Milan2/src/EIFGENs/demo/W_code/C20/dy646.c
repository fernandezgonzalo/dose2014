...
extern EIF_TYPED_VALUE F646_4802(EIF_REFERENCE);
extern EIF_TYPED_VALUE F646_4803(EIF_REFERENCE);
extern void F646_4809(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F646_4812(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F646_4813(EIF_REFERENCE);
extern EIF_TYPED_VALUE F646_4814(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F646_4802 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 645, Current, 0, 0, 6841);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(645, Current, 6841);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F646_4803 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 645, Current, 0, 0, 6842);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(645, Current, 6842);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {DYNAMIC_CHAIN}.prune */
void F646_4809 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur8_1 ur8_1x.it_r8
	...
	RTEAA(l_feature_name, 645, Current, 0, 1, 6837);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(645, Current, 6837);
	RTIV(Current, RTAL);
...
void F646_4812 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur8_1 ur8_1x.it_r8
	...
	RTEAA(l_feature_name, 645, Current, 0, 1, 6838);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(645, Current, 6838);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
void F646_4813 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 645, Current, 0, 0, 6839);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(645, Current, 6839);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
EIF_TYPED_VALUE F646_4814 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur8_1 ur8_1x.it_r8
	...
	RTEAA(l_feature_name, 645, Current, 2, 1, 6840);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(645, Current, 6840);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	...
	for (;;) {
		...
		ur8_1 = tr8_1;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(2204, "extend", Result))(Result, ur8_1x);
		RTHOOK(9);
