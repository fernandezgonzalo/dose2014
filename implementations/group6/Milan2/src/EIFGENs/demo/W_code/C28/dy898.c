...
extern EIF_TYPED_VALUE F898_4802(EIF_REFERENCE);
extern EIF_TYPED_VALUE F898_4803(EIF_REFERENCE);
extern void F898_4809(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F898_4812(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F898_4813(EIF_REFERENCE);
extern EIF_TYPED_VALUE F898_4814(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F898_4802 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 897, Current, 0, 0, 6877);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(897, Current, 6877);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F898_4803 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 897, Current, 0, 0, 6878);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(897, Current, 6878);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {DYNAMIC_CHAIN}.prune */
void F898_4809 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uu2_1 uu2_1x.it_n2
	...
	RTEAA(l_feature_name, 897, Current, 0, 1, 6873);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(897, Current, 6873);
	RTIV(Current, RTAL);
...
void F898_4812 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uu2_1 uu2_1x.it_n2
	...
	RTEAA(l_feature_name, 897, Current, 0, 1, 6874);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(897, Current, 6874);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
void F898_4813 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 897, Current, 0, 0, 6875);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(897, Current, 6875);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
EIF_TYPED_VALUE F898_4814 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uu2_1 uu2_1x.it_n2
	...
	RTEAA(l_feature_name, 897, Current, 2, 1, 6876);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(897, Current, 6876);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	...
	for (;;) {
		...
		uu2_1 = tu2_1;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(2204, "extend", Result))(Result, uu2_1x);
		RTHOOK(9);
