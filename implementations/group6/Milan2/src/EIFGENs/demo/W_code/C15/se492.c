...
extern EIF_TYPED_VALUE F492_2559(EIF_REFERENCE);
extern EIF_TYPED_VALUE F492_2560(EIF_REFERENCE);
extern void F492_2561(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F492_2562(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F492_2563(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F492_2564(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F492_2565(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {SEQUENCE}.readable */
EIF_TYPED_VALUE F492_2559 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 491, Current, 0, 0, 2933);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(491, Current, 2933);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {SEQUENCE}.writable */
EIF_TYPED_VALUE F492_2560 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 491, Current, 0, 0, 2934);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(491, Current, 2934);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {SEQUENCE}.force */
void F492_2561 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 491, Current, 0, 1, 2935);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(491, Current, 2935);
	RTIV(Current, RTAL);
...
/* {SEQUENCE}.append */
void F492_2562 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 491, Current, 1, 1, 2936);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(491, Current, 2936);
	if (arg1) {
		{
...
/* {SEQUENCE}.put */
void F492_2563 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 491, Current, 0, 1, 2937);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(491, Current, 2937);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("extendible", EX_PRE);
...
/* {SEQUENCE}.prune */
void F492_2564 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 491, Current, 0, 1, 2938);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(491, Current, 2938);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
/* {SEQUENCE}.prune_all */
void F492_2565 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 491, Current, 0, 1, 2939);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(491, Current, 2939);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
