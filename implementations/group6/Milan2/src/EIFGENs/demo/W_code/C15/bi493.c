...
extern EIF_TYPED_VALUE F493_2445(EIF_REFERENCE);
extern void F493_2448(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F493_8158(EIF_REFERENCE, int);
...
/* {BILINEAR}.off */
EIF_TYPED_VALUE F493_2445 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 492, Current, 0, 0, 2636);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(492, Current, 2636);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BILINEAR}.search */
void F493_2448 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 492, Current, 0, 1, 2637);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(492, Current, 2637);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tb1 = '\0';
	tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(2186, dtype))(Current)).it_b);
...
/* {BILINEAR}._invariant */
void F493_8158 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 492, Current, 0, 8157);
	RTSA(dtype);
	RTME(dtype, 0);
