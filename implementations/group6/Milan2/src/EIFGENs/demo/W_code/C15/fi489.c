...
extern EIF_TYPED_VALUE F489_2456(EIF_REFERENCE);
extern void F489_8160(EIF_REFERENCE, int);
...
/* {FINITE}.is_empty */
EIF_TYPED_VALUE F489_2456 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 488, Current, 0, 0, 2673);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(488, Current, 2673);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {FINITE}._invariant */
void F489_8160 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 488, Current, 0, 8159);
	RTSA(dtype);
	RTME(dtype, 0);
