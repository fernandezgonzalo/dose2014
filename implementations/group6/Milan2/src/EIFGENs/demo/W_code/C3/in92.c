...
extern EIF_TYPED_VALUE F92_1441(EIF_REFERENCE);
extern EIF_TYPED_VALUE F92_1442(EIF_REFERENCE);
extern EIF_TYPED_VALUE F92_1443(EIF_REFERENCE);
extern void F92_1444(EIF_REFERENCE, EIF_TYPED_VALUE);extern void en_local_host_name(EIF_POINTER);
...
EIF_TYPED_VALUE F92_1441 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 91, Current, 1, 0, 1442);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(91, Current, 1442);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	RTHOOK(2);
	tp1 = *(EIF_POINTER *)(loc1 + RTVA(3087, "item", loc1));
	up1 = tp1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(1369, Dtype(Current)))(Current, up1x);
	RTHOOK(3);
...
RTOID (F92_1442)
EIF_TYPED_VALUE F92_1442 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 91, Current, 0, 0, 1443);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(91, Current, 1443);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF800005E, 0,0); /* Result */
	
	tr1 = RTLN(96);
	tr2 = RTMS_EX_H("0.0.0.0",7,1402630960);
	ur1 = tr2;
	ur2 = NULL;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWC(1419, Dtype(tr1)))(tr1, ur1x, ur2x);
	RTNHOOK(1,1);
	Result = (EIF_REFERENCE) RTCCL(tr1);
	RTVI(Current, RTAL);
	RTRS;
...
RTOID (F92_1443)
EIF_TYPED_VALUE F92_1443 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 91, Current, 0, 0, 1444);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(91, Current, 1444);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF800005E, 0,0); /* Result */
...
#define arg1 arg1x.it_p
	...
	RTEAA(l_feature_name, 91, Current, 0, 1, 1445);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 1);
	RTDBGEAA(91, Current, 1445);
