...
extern void F93_1448(EIF_REFERENCE, EIF_TYPED_VALUE);extern void en_local_host_name(EIF_POINTER);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 92, Current, 1, 0, 1446);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(92, Current, 1446);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	up1 = tp1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(1370, Dtype(Current)))(Current, up1x);
	RTHOOK(3);
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 92, Current, 0, 0, 1447);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(92, Current, 1447);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	...
	*((EIF_NATURAL_8 *)tr4+15) = (EIF_NATURAL_8) tu1_1;
	...
	ur2 = RTCCL(tr3);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWC(1403, Dtype(tr1)))(tr1, ur1x, ur2x);
	RTNHOOK(1,1);
	Result = (EIF_REFERENCE) RTCCL(tr1);
	RTVI(Current, RTAL);
	RTRS;
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 92, Current, 0, 0, 1448);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(92, Current, 1448);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF800005E, 0,0); /* Result */
...
void F93_1448 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_p
	...
	RTEAA(l_feature_name, 92, Current, 0, 1, 1449);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 1);
	RTDBGEAA(92, Current, 1449);
