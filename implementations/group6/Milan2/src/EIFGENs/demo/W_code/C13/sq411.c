...
extern EIF_TYPED_VALUE F411_8206(EIF_REFERENCE);
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 410, Current, 1, 2, 13795);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
body:;
	RTHOOK(6);
	tb1 = *(EIF_BOOLEAN *)(Current + RTWA(6464, dtype));
	if (tb1) {
		RTHOOK(7);
...
EIF_TYPED_VALUE F411_8206 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
	r.it_b = *(EIF_BOOLEAN *)(Current + RTWA(6470,Dtype(Current)));
	return r;
}
