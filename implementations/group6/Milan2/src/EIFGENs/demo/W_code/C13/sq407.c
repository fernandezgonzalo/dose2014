...
extern void F407_8124(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F407_8125(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F407_8126(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
...
void F407_8124 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 406, Current, 0, 1, 13714);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(406, Current, 13714);
	if (arg1) {
		RTCC(arg1, 406, l_feature_name, 1, 306);
	}
	RTIV(Current, RTAL);
...
EIF_TYPED_VALUE F407_8125 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 406, Current, 0, 1, 13715);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(406, Current, 13715);
	RTCC(arg1, 406, l_feature_name, 1, RTWCT(6383, dtype, Dftype(Current)));
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F407_8126 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 406, Current, 0, 2, 13716);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(406, Current, 13716);
	if (arg1) {
		RTCC(arg1, 406, l_feature_name, 1, 391);
	}
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
