...
extern void F409_8129(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F409_8130(EIF_REFERENCE);
...
void F409_8129 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 408, Current, 0, 2, 13719);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(408, Current, 13719);
	if (arg1) {
		RTCC(arg1, 408, l_feature_name, 1, 391);
	}
	RTIV(Current, RTAL);
...
EIF_TYPED_VALUE F409_8130 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REAL64;
	r.it_r8 = *(EIF_REAL_64 *)(Current + RTWA(6391,Dtype(Current)));
	return r;
}
