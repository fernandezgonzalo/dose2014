...
extern EIF_TYPED_VALUE F209_2627(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F209_2627 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 208, Current, 1, 1, 3080);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(208, Current, 3080);
	if (arg1) {
		RTCC(arg1, 208, l_feature_name, 1, 306);
	}
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	RTHOOK(5);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(4651, "left_adjust", Result))(Result);
	RTHOOK(6);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(4652, "right_adjust", Result))(Result);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(7);
	RTDBGLE;
