...
extern EIF_TYPED_VALUE F843_2416(EIF_REFERENCE);
extern EIF_TYPED_VALUE F843_2417(EIF_REFERENCE);
extern EIF_TYPED_VALUE F843_2418(EIF_REFERENCE);
extern void F843_2419(EIF_REFERENCE);
extern void F843_2420(EIF_REFERENCE);
...
/* {CONTAINER}.empty */
EIF_TYPED_VALUE F843_2416 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 842, Current, 0, 0, 2409);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(842, Current, 2409);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F843_2417 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F843_2418 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 842, Current, 0, 0, 2406);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(842, Current, 2406);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
void F843_2419 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 842, Current, 0, 0, 2407);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(842, Current, 2407);
	RTIV(Current, RTAL);
...
void F843_2420 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 842, Current, 0, 0, 2408);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(842, Current, 2408);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("changeable_comparison_criterion", EX_PRE);
