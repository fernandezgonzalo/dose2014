...
extern EIF_TYPED_VALUE F727_4609(EIF_REFERENCE);
...
EIF_TYPED_VALUE F727_4609 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 726, Current, 0, 0, 5355);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(726, Current, 5355);
	RTIV(Current, RTAL);
	RTHOOK(1);
