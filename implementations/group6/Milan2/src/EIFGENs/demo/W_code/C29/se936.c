...
extern EIF_TYPED_VALUE F936_2480(EIF_REFERENCE);
...
EIF_TYPED_VALUE F936_2480 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 935, Current, 0, 0, 2827);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(935, Current, 2827);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
	
	Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(2162, dtype))(Current)).it_b);
	if (RTAL & CK_ENSURE) {
		RTHOOK(2);
