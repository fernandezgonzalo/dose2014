...
extern EIF_TYPED_VALUE F526_4802(EIF_REFERENCE);
extern EIF_TYPED_VALUE F526_4803(EIF_REFERENCE);
extern void F526_4809(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F526_4812(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F526_4813(EIF_REFERENCE);
extern EIF_TYPED_VALUE F526_4814(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F526_4802 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 525, Current, 0, 0, 6823);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(525, Current, 6823);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F526_4803 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 525, Current, 0, 0, 6824);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(525, Current, 6824);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
#define uu4_1 uu4_1x.it_n4
	...
	RTEAA(l_feature_name, 525, Current, 0, 1, 6819);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(525, Current, 6819);
	RTIV(Current, RTAL);
...
void F526_4812 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uu4_1 uu4_1x.it_n4
	...
	RTEAA(l_feature_name, 525, Current, 0, 1, 6820);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(525, Current, 6820);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
void F526_4813 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 525, Current, 0, 0, 6821);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(525, Current, 6821);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
EIF_TYPED_VALUE F526_4814 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uu4_1 uu4_1x.it_n4
	...
	RTEAA(l_feature_name, 525, Current, 2, 1, 6822);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(525, Current, 6822);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	...
	for (;;) {
		...
		uu4_1 = tu4_1;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(2204, "extend", Result))(Result, uu4_1x);
		RTHOOK(9);
