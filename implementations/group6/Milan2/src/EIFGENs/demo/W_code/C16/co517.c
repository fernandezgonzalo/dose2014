...
extern EIF_TYPED_VALUE F517_2416(EIF_REFERENCE);
extern EIF_TYPED_VALUE F517_2417(EIF_REFERENCE);
extern EIF_TYPED_VALUE F517_2418(EIF_REFERENCE);
extern void F517_2419(EIF_REFERENCE);
extern void F517_2420(EIF_REFERENCE);
...
/* {CONTAINER}.empty */
EIF_TYPED_VALUE F517_2416 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 516, Current, 0, 0, 2369);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(516, Current, 2369);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F517_2417 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F517_2418 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 516, Current, 0, 0, 2366);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(516, Current, 2366);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
void F517_2419 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 516, Current, 0, 0, 2367);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(516, Current, 2367);
	RTIV(Current, RTAL);
...
void F517_2420 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 516, Current, 0, 0, 2368);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(516, Current, 2368);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("changeable_comparison_criterion", EX_PRE);
