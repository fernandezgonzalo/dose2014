...
extern void F541_2508(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F541_2509(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {STACK}.replace */
void F541_2508 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 540, Current, 0, 1, 2874);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(540, Current, 2874);
	RTIV(Current, RTAL);
...
/* {STACK}.fill */
void F541_2509 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 540, Current, 1, 1, 2875);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(540, Current, 2875);
	if (arg1) {
		{
			static EIF_TYPE_INDEX typarr0[] = {541,0,0xFFFF};
...
body:;
	...
	for (;;) {
		...
		if (tb1) break;
		RTHOOK(6);
		tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(2170, "item", arg1))(arg1)).it_b);
		ub1 = tb2;
	...
	for (;;) {
		...
		if (tb2) break;
		RTHOOK(9);
		tb3 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(2217, "item", loc1))(loc1)).it_b);
		ub1 = tb3;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(2204, dtype))(Current, ub1x);
		RTHOOK(10);
