...
extern EIF_TYPED_VALUE F549_2498(EIF_REFERENCE);
extern EIF_TYPED_VALUE F549_2499(EIF_REFERENCE);
extern void F549_2500(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F549_8164(EIF_REFERENCE, int);
...
/* {DISPENSER}.readable */
EIF_TYPED_VALUE F549_2498 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 548, Current, 0, 0, 2871);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(548, Current, 2871);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {DISPENSER}.writable */
EIF_TYPED_VALUE F549_2499 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 548, Current, 0, 0, 2872);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(548, Current, 2872);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {DISPENSER}.append */
void F549_2500 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 548, Current, 0, 1, 2873);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(548, Current, 2873);
	if (arg1) {
		{
			...
			RTCC(arg1, 548, l_feature_name, 1, typres0);
		}
	}
	RTIV(Current, RTAL);
...
void F549_8164 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 548, Current, 0, 8163);
	RTSA(dtype);
	RTME(dtype, 0);
