...
extern void F459_2611(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F459_2612(EIF_REFERENCE);
extern EIF_TYPED_VALUE F459_2613(EIF_REFERENCE);
extern EIF_TYPED_VALUE F459_2614(EIF_REFERENCE);
extern void F459_8166(EIF_REFERENCE, int);
...
void F459_2611 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define arg3 arg3x.it_b
	...
	RTEAA(l_feature_name, 458, Current, 0, 3, 3053);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(458, Current, 3053);
	RTCC(arg1, 458, l_feature_name, 1, RTWCT(2301, dtype, Dftype(Current)));
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 2301, 0xF80001C8, 0); /* active */
...
EIF_TYPED_VALUE F459_2612 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F459_2613 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F459_2614 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
void F459_8166 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 458, Current, 0, 8165);
	RTSA(dtype);
	RTME(dtype, 0);
