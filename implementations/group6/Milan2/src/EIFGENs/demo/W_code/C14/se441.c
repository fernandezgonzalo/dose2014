...
extern EIF_TYPED_VALUE F441_2559(EIF_REFERENCE);
extern EIF_TYPED_VALUE F441_2560(EIF_REFERENCE);
extern void F441_2561(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F441_2562(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F441_2563(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F441_2564(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F441_2565(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {SEQUENCE}.readable */
EIF_TYPED_VALUE F441_2559 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 440, Current, 0, 0, 2926);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(440, Current, 2926);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {SEQUENCE}.writable */
EIF_TYPED_VALUE F441_2560 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 440, Current, 0, 0, 2927);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(440, Current, 2927);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {SEQUENCE}.force */
void F441_2561 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 440, Current, 0, 1, 2928);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(440, Current, 2928);
	RTCC(arg1, 440, l_feature_name, 1, RTWCT(2217, dtype, Dftype(Current)));
	RTIV(Current, RTAL);
...
/* {SEQUENCE}.append */
void F441_2562 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 440, Current, 1, 1, 2929);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(440, Current, 2929);
	if (arg1) {
		{
			...
			RTCC(arg1, 440, l_feature_name, 1, typres0);
		}
	}
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
...
/* {SEQUENCE}.put */
void F441_2563 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 440, Current, 0, 1, 2930);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(440, Current, 2930);
	RTCC(arg1, 440, l_feature_name, 1, RTWCT(2217, dtype, Dftype(Current)));
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
/* {SEQUENCE}.prune */
void F441_2564 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 440, Current, 0, 1, 2931);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(440, Current, 2931);
	RTCC(arg1, 440, l_feature_name, 1, RTWCT(2217, dtype, Dftype(Current)));
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
/* {SEQUENCE}.prune_all */
void F441_2565 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 440, Current, 0, 1, 2932);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(440, Current, 2932);
	RTCC(arg1, 440, l_feature_name, 1, RTWCT(2217, dtype, Dftype(Current)));
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
