...
extern EIF_TYPED_VALUE F662_4609(EIF_REFERENCE);
...
EIF_TYPED_VALUE F662_4609 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 661, Current, 0, 0, 5353);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(661, Current, 5353);
	RTIV(Current, RTAL);
	RTHOOK(1);
