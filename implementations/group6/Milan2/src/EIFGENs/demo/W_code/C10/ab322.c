...
extern EIF_TYPED_VALUE F322_6246(EIF_REFERENCE);
...
EIF_TYPED_VALUE F322_6246 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 321, Current, 0, 0, 10341);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(321, Current, 10341);
	RTIV(Current, RTAL);
	RTHOOK(1);
