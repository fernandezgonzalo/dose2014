...
extern EIF_TYPED_VALUE F607_2458(EIF_REFERENCE);
extern void F607_8161(EIF_REFERENCE, int);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F607_2458 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 606, Current, 0, 0, 2704);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(606, Current, 2704);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F607_8161 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 606, Current, 0, 8160);
	RTSA(dtype);
	RTME(dtype, 0);
