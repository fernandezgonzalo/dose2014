...
EIF_INTEGER_32 F157_1947 (EIF_REFERENCE Current)
{
	return (EIF_INTEGER_32) ((EIF_INTEGER_32) 255L);
}

/* {STRING_8_SEARCHER}.substring_index_with_deltas */
EIF_INTEGER_32 F157_1948 (EIF_REFERENCE Current, EIF_REFERENCE arg1, EIF_REFERENCE arg2, EIF_INTEGER_32 arg3, EIF_INTEGER_32 arg4)
{
	GTCX
	...
	if ((EIF_BOOLEAN)(arg1 == arg2)) {
		...
		loc4 = (FUNCTION_CAST(EIF_INTEGER_32, (EIF_REFERENCE)) R4616[Dtype(arg2)-734])(RTCV(arg2));
		loc8 = *(EIF_REFERENCE *)(RTCV(arg1) + O4734[Dtype(arg1)-736]);
		loc9 = (FUNCTION_CAST(EIF_INTEGER_32, (EIF_REFERENCE)) R4735[Dtype(arg1)-736])(RTCV(arg1));
		...
		for (;;) {
			...
			for (;;) {
				...
				tu4_2 = (FUNCTION_CAST(EIF_NATURAL_32, (EIF_REFERENCE, EIF_INTEGER_32)) R4579[Dtype(arg2)-735])(RTCV(arg2), (EIF_INTEGER_32) (loc2 + ((EIF_INTEGER_32) 1L)));
