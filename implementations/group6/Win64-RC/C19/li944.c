...
EIF_INTEGER_32 F557_4607 (EIF_REFERENCE Current)
{
	GTCX
	...
	if (*(EIF_BOOLEAN *)(Current+ _CHROFF_2_0_)) {
		RTLE;
		return (EIF_INTEGER_32) F544_4584(Current);
	} else {
...
EIF_BOOLEAN F557_4608 (EIF_REFERENCE Current)
{
	GTCX
	...
	if (*(EIF_BOOLEAN *)(Current+ _CHROFF_2_0_)) {
		RTLE;
		return (EIF_BOOLEAN) F544_4596(Current);
	} else {
		Result = '\01';
...
void F557_4609 (EIF_REFERENCE Current)
{
	GTCX
	EIF_REFERENCE tr1 = NULL;
	RTLD;
...
void F557_4610 (EIF_REFERENCE Current)
{
	GTCX
...
EIF_REFERENCE F557_4611 (EIF_REFERENCE Current)
{
...
EIF_REFERENCE F557_4612 (EIF_REFERENCE Current)
{
